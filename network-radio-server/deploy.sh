...
install_dir "$ROOT_DIR/ser2net/ser2net.conf.example" "$SER2NET_CONF"
...
install_dir "$ROOT_DIR/generated/systemd/radio-audio-streamer.service" "$SYSTEMD_DIR/radio-audio-streamer.service"
install_dir "$ROOT_DIR/generated/systemd/usbipd.service" "$SYSTEMD_DIR/usbipd.service"
